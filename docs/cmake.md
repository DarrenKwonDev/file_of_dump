...
-   [linking 관련 cmake](#linking-%EA%B4%80%EB%A0%A8-cmake)
-   [Different Linking Types (PUBLIC, PRIVATE, INTERFACE). 생성된 lib를 어떤 방식으로 linking할 것인가.](#different-linking-types-public-private-interface-%EC%83%9D%EC%84%B1%EB%90%9C-lib%EB%A5%BC-%EC%96%B4%EB%96%A4-%EB%B0%A9%EC%8B%9D%EC%9C%BC%EB%A1%9C-linking%ED%95%A0-%EA%B2%83%EC%9D%B8%EA%B0%80)
    -   [PUBLIC](#public)
    -   [PRIVATE](#private)
    -   [INTERFACE](#interface)
-   [Different Library Types. lib에는 어떤 타입이 있는가.](#different-library-types-lib%EC%97%90%EB%8A%94-%EC%96%B4%EB%96%A4-%ED%83%80%EC%9E%85%EC%9D%B4-%EC%9E%88%EB%8A%94%EA%B0%80)
    -   [Library](#library)
...
-   [external lib](#external-lib)
    ...
    -   [option 2. FetchContent (+ CMake 3.11)](#option-2-fetchcontent--cmake-311)
        -   [fetch content 관련 함수](#fetch-content-%EA%B4%80%EB%A0%A8-%ED%95%A8%EC%88%98)
...
## Linking Types (PUBLIC, PRIVATE, INTERFACE). 생성된 lib를 어떤 방식으로 linking할 것인가.
...
## Library Types. lib에는 어떤 타입이 있는가.
